  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved region as @region" do
        ...
        post :create, {:region => { "id" => "invalid value" }}, valid_session
        assigns(:region).should be_a_new(Region)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested region" do
        ...
        Region.any_instance.should_receive(:update_attributes).with({ "id" => "1" })
        put :update, {:id => region.to_param, :region => { "id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the region as @region" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Region.any_instance.stub(:save).and_return(false)
        put :update, {:id => region.to_param, :region => { "id" => "invalid value" }}, valid_session
        assigns(:region).should eq(region)
      end
