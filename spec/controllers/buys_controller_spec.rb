  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved buy as @buy" do
        ...
        post :create, {:buy => { "title" => "invalid value" }}, valid_session
        assigns(:buy).should be_a_new(Buy)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested buy" do
        ...
        Buy.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => buy.to_param, :buy => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the buy as @buy" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Buy.any_instance.stub(:save).and_return(false)
        put :update, {:id => buy.to_param, :buy => { "title" => "invalid value" }}, valid_session
        assigns(:buy).should eq(buy)
      end
